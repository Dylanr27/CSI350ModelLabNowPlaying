...
namespace NowPlaying.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Count,MovieId,ApplicationUserId")] Ticket ticket)
        {
            ...
            ViewData["ApplicationUserId"] = new SelectList(_context.Users, "Id", "Id", ticket.ApplicationUserId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Count,MovieId,ApplicationUserId")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
